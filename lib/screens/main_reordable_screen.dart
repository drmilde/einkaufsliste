...
class MainReordableScreen extends StatefulWidget {
  const MainReordableScreen({Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _MainReordableScreenState();
  }
}
...
class _MainReordableScreenState extends State<MainReordableScreen> {
